...
<h1>Bienvenido a Absorción Atómica | Análisis de Metales y Minerales</h1>

<p>Bienvenido a Absorción Atómica | Análisis de Metales y Minerales, diseñado por Pablo Nieto (GitHub: <a href="https://github.com/pabloWIB">pabloWIB</a>)</p>
...
<ul>
    ...
    <li><strong>Resultados Rápidos:</strong> Ofrecemos análisis precisos y rápidos de metales y minerales.</li>
    <li><strong>Servicios Acreditados:</strong> Todos nuestros servicios están acreditados por la norma ISO, garantizando la calidad y fiabilidad de nuestros resultados.</li>
</ul>
